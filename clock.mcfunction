...
execute if entity @a[x=65,y=61,z=-633,dx=17,dy=3,dz=14] run tag @e[type=armor_stand,name=Global,score_mmSwitch=130,score_mmSwitch_min=130] add mmWait
...
execute if entity @e[type=armor_stand,name=Global,scores={mmSwitch=1..130},tag=!mmWait] run tp @e[type=armor_stand,name=Mushroom,tag=!mmSelected] ~ ~-0.1 ~
execute if entity @e[type=armor_stand,name=Global,scores={mmSwitch=131..260},tag=!mmWait] run tp @e[type=armor_stand,name=Mushroom,tag=!mmSelected] ~ ~0.1 ~
