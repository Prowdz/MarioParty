...
tag @a remove Dying
execute as @e[x=74,y=57,z=-650,dx=28,dy=4,dz=60,tag=Blooper] at @s run teleport @p[m=2,tag=Dead] ~ ~ ~ 90 ~
...
execute as @e[x=45,y=57,z=-650,dx=28,dy=4,dz=60,tag=Blooper] at @s run teleport @p[m=2,tag=Dead] ~ ~ ~ -90 ~
...
execute if @e[x=45,y=57,z=-650,dx=56,dy=4,dz=60,tag=Blooper] run teleport @a[tag=Dead,m=2] 74.0 80 -637
